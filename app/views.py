...
#class based views for login, logout, sign up, index
################################################################################
...
def StockAddView(request, symbol):
    ...
    if request.method == "POST":
        if form.is_valid():
            ...
            jdata = requests.get("https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol={}&apikey=Q3XZZ2CPZ3JM3VFY".format(symbol))
            data = jdata.json()
    ...
    jdata1 = requests.get("https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol={}&apikey=Q3XZZ2CPZ3JM3VFY".format(symbol))
    data = jdata1.json()
...
def stock_search(request):
    if request.method == "POST":
        ...
        jdata = requests.get("https://www.alphavantage.co/query?function=SYMBOL_SEARCH&keywords={}&apikey=Q3XZZ2CPZ3JM3VFY".format(symbol))
        data = jdata.json()
        results = []
